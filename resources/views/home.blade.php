                    ...
                    <div class="container bg-light p-4 sec">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-6">
                                <div class="small-box bg-info back">
                                    <div class="inner">
                                        <img src="{{ asset('users/dist/img/twelve.png') }}" class="mb-2"
                                            width="50">
                                        <p>TODAY JOINING<br>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <table class="table mt-2">
                                    <tbody>
                                        <tr>
                                            <th class="top"> <input type="text" id="myInput"
                                                    value="{{ route('register', ['spid' => Auth::user()->uid]) }}"
                                                    style="width: 100%;     margin-right: 12px; padding:  4px;font-size:  16px;background: #ffffff;color:  #615b5b; border: 1px solid #ddd; font-weight:  800;"
                                                    readonly="true"></th>
                                            <td class="top"> <a href="#" class="btn-inverse"
                                                    onclick="copyToClipboard()"><button
                                                        class="btn btn-primary rounded-5"><i
                                                            class="fa-solid fa-copy"></i></button></a></td>
