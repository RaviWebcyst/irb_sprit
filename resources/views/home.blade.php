                    ...
                    <div class="container bground2">
                        <div class="row">
                            <div class="col-lg-12 pt-3 text-center">
                                <img src="https://adeshbiotechagri.com/users/dist/img/avatar5.png" class="user"
                                    width="100">
                                <h4 class="bold mt-2 text-light">{{ Auth::user()->name }}</h4>
                                <p class="num pb-1">( <strong style="color:#5e1dab;">{{ Auth::user()->uid }})</strong></p><strong
                                    style="color:#5e1dab;">
                                </strong>
                            </div><strong style="color:#5e1dab;">
                            </strong>
                        </div>
                    </div>
                </section>
